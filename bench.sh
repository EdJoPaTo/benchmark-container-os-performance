...
# See ffmpeg -encoders and ffmpeg -codecs
...
hyperfine --shell=none --warmup 1 --prepare 'touch src/main.rs' 'cargo clippy --all-targets'
hyperfine --shell=none --warmup 1 --prepare 'touch src/main.rs' 'cargo test'
